...
#
    ...
    my $self = {
        ...
        # parameter "SendCookie": send session cookie (default: 1)
        sendcookie => $params->{SendCookie} || 1,
...
###########################################################
	...
	$self->_sendSessionCookie if $self->{sendcookie};
...
Send a cookie containing the session id to the client. (Default: 1)
